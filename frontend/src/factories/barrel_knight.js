...
export default class Barrel_Knight extends Phaser.Physics.Arcade.Sprite {
    constructor(scene, x, y) {
        super(scene, x, y, "barrel_idle", "barrel_idle_1");
        ...
        this.attackRange = 200; // range to start attacking player
    ...
    startIdle() {
        ...
        if (!this.anims.isPlaying || this.anims.currentAnim.key !== "barrel_idle") this.play("barrel_idle");
    ...
    takeDamage(amount, source) {
        ...
        this.play("barrel_hurt");

        this.once(Phaser.Animations.Events.ANIMATION_COMPLETE_KEY + "barrel_hurt", () => {
            if (!this.isDead) {
                this.isKnockedBack = false;
                this.play("barrel_idle");
            }
        })

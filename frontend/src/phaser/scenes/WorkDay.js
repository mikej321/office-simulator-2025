...
class WorkDay extends Phaser.Scene {
  ...
  create() {
    ...
    if (!this.scene.isActive("MusicManager")) {
      ...
      // Wait for MusicManager to be ready before playing track
    ...
    this.floorDeco = map.createLayer(
      "Floor Decorations",
      this.tileset,
      offsetX,
      offsetY
    );
    this.separators = map.createLayer(
      "Cubicle Separators",
      this.tileset,
      offsetX,
      offsetY
    );
    this.deskRight = map.createLayer(
      "Cubicle Desk Right",
      this.tileset,
      offsetX,
      offsetY
    );
    this.deskLeft = map.createLayer(
      "Cubicle Desk Left",
      this.tileset,
      offsetX,
      offsetY
    ...
    this.wallDeco = map.createLayer(
      "Wall Decorations",
      this.tileset,
      offsetX,
      offsetY
    );
    this.tableDeco = map.createLayer(
      "Table Decorations",
      this.tileset,
      offsetX,
      offsetY
    ...
    this.interactionText = this.add
      .text(
        offsetX + gameWidth / 2,
        offsetY + gameHeight - 50,
        "Press E to work for the day",
        this.textStyle
      )
      .setOrigin(0.5);
    ...
    this.avatarText = this.add
      .text(this.avatar.x, this.avatar.y - 50, "", this.textStyle)
      .setOrigin(0.5)
      .setVisible(false);
